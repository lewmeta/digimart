...
return [
    ...
    */
    ...
    'passwords' => [
        ...
        // Define Admin password broker
        'admins' => [
            'provider' => 'admins',
            'table' => env('AUTH_PASSWORD_RESET_TOKEN_TABLE', 'password_reset_tokens'),
            'expire' => 60, // The number of minutes the reset token is valid
            'throttle' => 60, // The number of seconds a user must wait before generating more tokens
        ]
    ],
